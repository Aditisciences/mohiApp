...
class RemoveFromWishRequest: BaseRequest<APIResponseParam.BaseResponse> {
    private var productData:APIRequestParam.RemoveFromWish?
    ...
    init(productData:APIRequestParam.RemoveFromWish, onSuccess:((_ response:APIResponseParam.BaseResponse)->Void)?, onError:((_ response:ErrorModel)->Void)?){
    ...
    override func main() {
        ...
        //        //Prepare URL String
        let urlParameter = String(format:APIParamConstants.kRemoveFromWishList)
