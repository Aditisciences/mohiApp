...
class AddToWishRequest:  BaseRequest<APIResponseParam.BaseResponse> {
    private var productData:APIRequestParam.AddToWish?
    ...
    init(productData:APIRequestParam.AddToWish, onSuccess:((_ response:APIResponseParam.BaseResponse)->Void)?, onError:((_ response:ErrorModel)->Void)?){
    ...
    override func main() {
        ...
        //        //Prepare URL String
        let urlParameter = String(format:APIParamConstants.kAddToWishList)
