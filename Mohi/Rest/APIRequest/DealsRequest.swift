...
class DealsRequest: BaseRequest<APIResponseParam.Deals> {
    private var productData:APIRequestParam.Deals?
    private var callBackSuccess:((_ response:APIResponseParam.Deals)->Void)?
    private var callBackError:((_ response:ErrorModel)->Void)?
    
    init(productData:APIRequestParam.Deals, onSuccess:((_ response:APIResponseParam.Deals)->Void)?, onError:((_ response:ErrorModel)->Void)?){
    ...
    override func main() {
        ...
        //        //Prepare URL String
        let urlParameter = String(format:APIParamConstants.kGetDeals)
    ...
    override func onSuccess(_ responseView:APIResponseParam.Deals?){
