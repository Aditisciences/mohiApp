...
//  Mohi
//
//  Created by Consagous on 07/11/17.
...
class PlaceOrderRequest: BaseRequest<APIResponseParam.BaseResponse> {
    private var productData:APIRequestParam.PlaceOrder?
    ...
    init(productData:APIRequestParam.PlaceOrder, onSuccess:((_ response:APIResponseParam.BaseResponse)->Void)?, onError:((_ response:ErrorModel)->Void)?){
    ...
    override func main() {
        ...
        //        //Prepare URL String
        let urlParameter = String(format:APIParamConstants.kPlaceOrder)
