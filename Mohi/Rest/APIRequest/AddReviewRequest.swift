...
//  Mohi
//
//  Created by Consagous on 02/11/17.
...
class AddReviewRequest: BaseRequest<APIResponseParam.BaseResponse> {
    private var productData:APIRequestParam.Review?
    ...
    init(productData:APIRequestParam.Review, onSuccess:((_ response:APIResponseParam.BaseResponse)->Void)?, onError:((_ response:ErrorModel)->Void)?){
    ...
    override func main() {
        ...
        //        //Prepare URL String
        let urlParameter = String(format:APIParamConstants.kAddReview)
