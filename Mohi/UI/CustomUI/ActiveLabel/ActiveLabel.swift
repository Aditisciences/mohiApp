...
@IBDesignable open class ActiveLabel: UILabel {
    ...
    fileprivate func addLinkAttribute(_ mutAttrString: NSMutableAttributedString) {
        ...
        // update for swift 4 for temp solution
        var tempAttributes:[String:Any] = [:]
        ...
        // update for swift 4
        tempAttributes.updateValue(font!, forKey: NSAttributedStringKey.font.rawValue)
        tempAttributes.updateValue(textColor, forKey: NSAttributedStringKey.foregroundColor.rawValue)
        ...
        for (type, elements) in activeElements {
            ...
            case .mention: attributes[NSAttributedStringKey.foregroundColor] = mentionColor
                tempAttributes.updateValue(mentionColor, forKey: NSAttributedStringKey.foregroundColor.rawValue)
            case .hashtag: attributes[NSAttributedStringKey.foregroundColor] = hashtagColor
                tempAttributes.updateValue(hashtagColor, forKey: NSAttributedStringKey.foregroundColor.rawValue)
            case .url: attributes[NSAttributedStringKey.foregroundColor] = URLColor
                tempAttributes.updateValue(URLColor, forKey: NSAttributedStringKey.foregroundColor.rawValue)
            case .custom: attributes[NSAttributedStringKey.foregroundColor] = customColor[type] ?? defaultCustomColor
                tempAttributes.updateValue(customColor[type] ?? defaultCustomColor, forKey: NSAttributedStringKey.foregroundColor.rawValue)
            }
            
            if let highlightFont = hightlightFont {
                attributes[NSAttributedStringKey.font] = highlightFont
                tempAttributes.updateValue(highlightFont, forKey: NSAttributedStringKey.font.rawValue)
            }
			
            if let configureLinkAttribute = configureLinkAttribute {
                //attributes = configureLinkAttribute(type, attributes, false)
//                public typealias ConfigureLinkAttribute = (ActiveType, [String : Any], Bool) -> ([String : Any])
                tempAttributes = configureLinkAttribute(type, tempAttributes, false)
            }
    ...
    fileprivate func updateAttributesWhenSelected(_ isSelected: Bool) {
        ...
        if isSelected {
            ...
            tempAttributes.updateValue(selectedColor, forKey: NSAttributedStringKey.foregroundColor.rawValue)
        } else {
            ...
            tempAttributes.updateValue(unselectedColor, forKey: NSAttributedStringKey.foregroundColor.rawValue)
        }
        ...
        if let configureLinkAttribute = configureLinkAttribute {
            ...
            //tempAttributes = tempAttributes.updateValue(highlightFont, forKey: NSAttributedStringKey.font.rawValue)
            tempAttributes = configureLinkAttribute(type, tempAttributes, isSelected)
        }
